...
public class getCompanies extends AsyncTask<String, Integer, String> {
    ...
    public getCompanies(AppCompatActivity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        while (!isCancelled()) {
            ...
            try {
                ...
                HttpPost httpPOst = new HttpPost(ConstantValues.BASE_URL + "get_companies");
        ...
        if(jsonArray != null){
            try{
                ...
                for (int i = 0 ; i < jsonArray.length() ; i++){
                    ...
                    companyCRUD.add( jsonArray.getJSONObject(i).getString("company_id") , jsonArray.getJSONObject(i).getString("company_name"));
                }

                if(networkTools.checkConnectivity()){
                    new getOutlets(actionBarActivity).execute();
                }else{
            ...
            Toast.makeText(actionBarActivity , "An error occured retrieving companies!!" , Toast.LENGTH_LONG).show();
