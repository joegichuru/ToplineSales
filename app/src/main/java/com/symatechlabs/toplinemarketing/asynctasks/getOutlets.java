...
public class getOutlets extends AsyncTask<String, Integer, String> {
    ...
    public getOutlets(AppCompatActivity activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        while (!isCancelled()) {
            ...
            try {
                ...
                HttpPost httpPOst = new HttpPost(ConstantValues.BASE_URL + "get_outlets");
        ...
        if(jsonArray != null){
            try{
                ...
                for (int i = 0 ; i < jsonArray.length() ; i++){
                    ...
                    outletCRUD.add( jsonArray.getJSONObject(i).getString("outlet_id") , jsonArray.getJSONObject(i).getString("outlet_name"));
                }

                if(networkTools.checkConnectivity()){
                    new getSubOutlets(actionBarActivity).execute();
                }else{
            ...
            Toast.makeText(actionBarActivity , "An error occured retrieving Outlets!!" , Toast.LENGTH_LONG).show();
